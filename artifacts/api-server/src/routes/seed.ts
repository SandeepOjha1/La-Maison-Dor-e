...
const PRODUCTS = [
  {
    ...
    price: 4.5,
    category: "Pastries",
    imageUrl: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=800&fit=crop&auto=format&q=80",
    featured: true,
    available: true,
    rating: 4.8,
    reviewCount: 124,
  },
  {
    ...
    price: 9.0,
    category: "Bread",
    imageUrl: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800&fit=crop&auto=format&q=80",
    featured: true,
    available: true,
    rating: 4.9,
    reviewCount: 89,
  },
  {
    ...
    price: 7.5,
    category: "Pastries",
    imageUrl: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 4.7,
    reviewCount: 56,
  },
  {
    ...
    price: 14.0,
    category: "Pastries",
    imageUrl: "https://images.unsplash.com/photo-1564355808539-22fda35bed7e?w=800&fit=crop&auto=format&q=80",
    featured: true,
    available: true,
    rating: 4.6,
    reviewCount: 203,
  },
  {
    ...
    price: 32.0,
    category: "Cakes",
    imageUrl: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=800&fit=crop&auto=format&q=80",
    featured: true,
    available: true,
    rating: 4.9,
    reviewCount: 178,
  },
  {
    ...
    price: 3.5,
    category: "Donuts",
    imageUrl: "https://images.unsplash.com/photo-1527515637462-cff94ebb58ab?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 4.5,
    reviewCount: 67,
  },
  {
    ...
    price: 5.0,
    category: "Coffee",
    imageUrl: "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 4.7,
    reviewCount: 312,
  },
  {
    ...
    price: 3.0,
    category: "Pastries",
    imageUrl: "https://images.unsplash.com/photo-1587241321921-91a834d6d191?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 4.4,
    reviewCount: 45,
  },
  {
    ...
    price: 3.5,
    category: "Bread",
    imageUrl: "https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 4.8,
    reviewCount: 290,
  },
  {
    ...
    price: 48.0,
    category: "Cakes",
    imageUrl: "https://images.unsplash.com/photo-1571115177098-24ec42ed204d?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 5.0,
    reviewCount: 34,
  },
  {
    ...
    price: 3.8,
    category: "Cookies",
    imageUrl: "https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=800&fit=crop&auto=format&q=80",
    featured: false,
    available: true,
    rating: 4.6,
    reviewCount: 88,
  },
  {
    ...
    price: 6.5,
    category: "Pastries",
    imageUrl: "https://images.unsplash.com/photo-1560008581-09826d1de69e?w=800&fit=crop&auto=format&q=80",
    featured: true,
    available: true,
    rating: 4.8,
    reviewCount: 142,
...
export async function seedDatabase(): Promise<void> {
  // Always refresh products to ensure latest image URLs
  await ProductModel.deleteMany({});
  await ProductModel.insertMany(PRODUCTS);
  logger.info("Products refreshed.");

  const adminExists = await UserModel.findOne({ email: "admin@lamaison.com" });
  if (!adminExists) {
    const adminHash = await bcrypt.hash("admin123", 10);
    await UserModel.create({ name: "Admin", email: "admin@lamaison.com", passwordHash: adminHash, role: "admin" });
